...
从 2014 年 docker 诞生起，Go 语言就开始在分布式领域崭露头角，之后 k8s，kong，groupcache，nats，etcd，tidb等让人们不断看到了 Go 在分布式领域的新的可能性。目前在大部分的分布式场景下，Go 语言都有相应的产品，无论是存储，rpc 框架，消息队列等等。Go 被称为分布式时代的 C 语言着实所言非虚。
